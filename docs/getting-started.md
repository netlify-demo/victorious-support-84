...
This Docusaurus project lives in a <a href='github.com/netlify-demo/victorious-support-84'
...
site:
    ...
    git clone github.com/netlify-demo/victorious-support-84
    cd victorious-support-84
